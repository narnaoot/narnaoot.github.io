...
- Hand-annotated with arrows explaining what each visual element means
...
- Elegant simplicity — one insight, one chart, total clarity
...
- Two data points per activity: 2015 (orange-red) vs 2016 (yellow) showing movement
- Annotated legend explains each shift (A–E)
...
- **Hand-drawn aesthetic** — sketchy fonts, wobbly lines, organic shapes. Feels personal, not corporate.
- **Data viz as self-expression** — charts used not for precision but for *personality*.
- **Wit built into the framing** — axis labels are the punchline ("How I Feel About It", "Too Stuck in Status Quo").
- **Limited palettes** — 2–4 colors per piece, always on a warm neutral bg (except the dark quadrant).
- **Annotated** — arrows and hand-notes explain the visual language; invites the reader in.
- **One idea per chart** — each piece makes exactly one point, clearly.
...
- Career timeline with "excitement" axis (like #1) — shows Apple, Cisco, etc. with honest energy levels
- Bell curve of ideal work conditions (like #2) — ambiguity vs. structure sweet spot
- A "what I actually do" radial or bubble chart — skills by frequency/enjoyment
- Personal evolution stacked chart — English Lit → tech → BA → data storytelling arc
